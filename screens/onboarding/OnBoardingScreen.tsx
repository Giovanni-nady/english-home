...
const OnBoardingScreen = () => {
  ...
  const pages = [
    {
      title: 'Your Gateway to Relaxation',
      description:
        'Indulge, Unwind, and Rejuvenate with SpaVation - Where Wellness Meets Luxury',
      image: require('./../../assets/images/onboarding1.png')
    },
    {
      title: 'Spavation Serenity',
      description: 'Immerse Yourself in Luxury, Awaken Your Senses',
      image: require('./../../assets/images/onboarding2.png')
    },
    {
      title: 'Elevating Wellness',
      description: 'Where Every Moment is a Journey to Bliss',
